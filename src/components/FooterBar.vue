      ...
      <footer>
        <section class="logo">
          ...
          <nav>
            <ul class="page-links">
              <li>
                <router-link :to="{ name: this.links.home }" class="hover-links">home</router-link>
              </li>
              <li>
                <router-link :to="{ name: this.links.about }" class="hover-links"
                  >about</router-link
                >
              </li>
            </ul>
...
export default {
  ...
  data() {
    return {
      ...
      socials: [
        { name: 'facebook', ico: require('../assets/icon-facebook.svg') },
        { name: 'pinterest', ico: require('../assets/icon-pinterest.svg') },
        { name: 'twitter', ico: require('../assets/icon-twitter.svg') },
      ],
      isOpen: false,
    };
  },
